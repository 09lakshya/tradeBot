...
def test_database_url_built_from_parts_by_default() -> None:
    s = Settings(**BASE, database_url_override=None)
...
def test_database_url_override_leaves_explicit_psycopg_scheme_untouched() -> None:
    ...
    assert Settings(**BASE, database_url_override=url).database_url == url


def test_redis_url_from_parts_by_default() -> None:
    s = Settings(**BASE, redis_host="rh", redis_port=6380, redis_db=2, redis_url_override=None)
...
def test_redis_url_override_supports_tls_and_auth() -> None:
    ...
    assert Settings(**BASE, redis_url_override=url).redis_url == url
